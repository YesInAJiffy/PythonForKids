...
def game():
    ...
    while True:
        ...
        if (new_head[0] < 0 or new_head[0] >= width or
            ...
            return score  # End the current game and return the score
        ...
        if new_head == food:
            ...
            food = (random.randrange(1, (width//food_size)) * food_size,
                    random.randrange(1, (height//food_size)) * food_size)
            eat_sound.play()
            score += 10  # Increase score when eating
        ...
        # Draw food
        pygame.draw.rect(screen, blue, (food[0], food[1], food_size, food_size))
...
while True:
    ...
    # Display the score
    score_text = font.render(f"Game Over! Final Score: {final_score}", True, red)
    screen.blit(score_text, (10, 200))
    # Update the display
    pygame.display.flip()
    pygame.time.delay(2000)  # Pause for 1 second before restarting
